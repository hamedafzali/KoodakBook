...
function Game({ max, onReplay, onHome }: { max: number; onReplay: () => void; onHome: () => void }) {
  ...
  useEffect(() => {
    if (done) { playComplete(); celebrate({ particleCount: 110, spread: 85, origin: { y: 0.45 }, colors: ['#38bdf8', '#fbbf24', '#a78bfa'] }) }
  }, [done])
  ...
  return (
    <div className="min-h-screen child-bg pb-nav">
      <PageHeader title="رقم‌های فارسی ۱۲۳" subtitle="۷ همان 7 است!" module="math" />
