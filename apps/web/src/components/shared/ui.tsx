...
export const ui = {
  ...
  btnPrimary: 'inline-flex items-center justify-center gap-2 font-bold rounded-md py-3 px-5 transition-transform active:scale-95 disabled:opacity-50 bg-brand-gradient text-on-brand shadow-md',
...
const VARIANT: Record<Variant, string> = {
  primary: 'bg-brand-gradient text-on-brand shadow-md',
