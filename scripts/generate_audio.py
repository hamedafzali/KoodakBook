...
SQL_FILES = [
    ...
    # 012 added the Critical categories (numbers 11–20, clothes, transport,
    # weather, school, opposites, questions, prepositions, نی‌نی) — these had
...
# The UPDATEs are idempotent by natural key, so re-stating the full set here is
# safe and additionally wires audio for words added after 005 (migration 012).
MIGRATION = os.path.join(ROOT, "supabase", "migrations", "015_audio_backfill.sql")
